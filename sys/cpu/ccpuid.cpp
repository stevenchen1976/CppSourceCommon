////////////////////////////////////////////////////////////
// ccpuid.cpp: CPUID信息（C++版源文件）.
// Author: zyl910
// Blog: http://www.cnblogs.com/zyl910
// URL: http://www.cnblogs.com/zyl910/archive/2012/09/29/ccpuid_v102.html
// Version: V1.02
// Updata: 2012-09-29
//
//
...
// 分成纯C版和C++版。将原 ccpuid.h 拆分为 ccpuid.h 与 ccpuid.hpp。ccpuid.cpp中的全局函数移至ccpuid.h，作为内联函数。
// 根据最新文档增加CPUF常数.
//
// [2012-08-22] V1.01
// 兼容GCC.
